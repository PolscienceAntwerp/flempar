...
Under its open data policy the Flemish parliament publishes its data on parliamentary proceedings via API. This API contains a large amount of data on MPs, legislative work, voting parliamentary documents.
